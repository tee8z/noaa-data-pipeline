...
file_service="parquet_file_service-x86_64-unknown-linux-gnu.tar.xz"

# Construct URL
daemon_url="https://github.com/$owner/$repo/releases/download/$tag/$daemon"
parquet_file_service_url="https://github.com/$owner/$repo/releases/download/$tag/$file_service"
...
tar -xf $file_service -C $full_path
